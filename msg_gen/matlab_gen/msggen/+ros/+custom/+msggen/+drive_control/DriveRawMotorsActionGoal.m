classdef DriveRawMotorsActionGoal < ros.Message
    %DriveRawMotorsActionGoal MATLAB implementation of drive_control/DriveRawMotorsActionGoal
    ...
    properties (Constant)
        MessageType = 'drive_control/DriveRawMotorsActionGoal' % The ROS message type
    end
    
    properties (Constant, Hidden)
        MD5Checksum = 'caae98b12e4025df8a5af65186227a55' % The MD5 Checksum of the message definition
    end
    ...
    properties (Constant, Access = protected)
        ...
        DriveControlDriveRawMotorsGoalClass = ros.msg.internal.MessageFactory.getClassForType('drive_control/DriveRawMotorsGoal') % Dispatch to MATLAB class for message type drive_control/DriveRawMotorsGoal
    ...
    methods
        function obj = DriveRawMotorsActionGoal(msg)
            %DriveRawMotorsActionGoal Construct the message object DriveRawMotorsActionGoal
        ...
        function set.Header(obj, header)
            ...
            validateattributes(header, {obj.StdMsgsHeaderClass}, {'nonempty', 'scalar'}, 'DriveRawMotorsActionGoal', 'Header');
        ...
        function set.GoalId(obj, goalid)
            ...
            validateattributes(goalid, {obj.ActionlibMsgsGoalIDClass}, {'nonempty', 'scalar'}, 'DriveRawMotorsActionGoal', 'GoalId');
        ...
        function goal = get.Goal(obj)
            ...
            if isempty(obj.Cache.Goal)
                obj.Cache.Goal = feval(obj.DriveControlDriveRawMotorsGoalClass, obj.JavaMessage.getGoal);
            end
            goal = obj.Cache.Goal;
        end
        ...
        function set.Goal(obj, goal)
            ...
            validateattributes(goal, {obj.DriveControlDriveRawMotorsGoalClass}, {'nonempty', 'scalar'}, 'DriveRawMotorsActionGoal', 'Goal');
    ...
    methods (Access = protected)
        ...
        function reload(obj, strObj)
            ...
            obj.Goal = feval([obj.DriveControlDriveRawMotorsGoalClass '.loadobj'], strObj.Goal);
        end
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.drive_control.DriveRawMotorsActionGoal.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.drive_control.DriveRawMotorsActionGoal;
            obj.reload(strObj);
        end
    end
end
