classdef DriveRawMotorsActionResult < ros.Message
    %DriveRawMotorsActionResult MATLAB implementation of drive_control/DriveRawMotorsActionResult
    ...
    properties (Constant)
        MessageType = 'drive_control/DriveRawMotorsActionResult' % The ROS message type
    end
    ...
    properties (Constant, Access = protected)
        ...
        DriveControlDriveRawMotorsResultClass = ros.msg.internal.MessageFactory.getClassForType('drive_control/DriveRawMotorsResult') % Dispatch to MATLAB class for message type drive_control/DriveRawMotorsResult
    ...
    methods
        function obj = DriveRawMotorsActionResult(msg)
            %DriveRawMotorsActionResult Construct the message object DriveRawMotorsActionResult
        ...
        function set.Header(obj, header)
            ...
            validateattributes(header, {obj.StdMsgsHeaderClass}, {'nonempty', 'scalar'}, 'DriveRawMotorsActionResult', 'Header');
        ...
        function set.Status(obj, status)
            ...
            validateattributes(status, {obj.ActionlibMsgsGoalStatusClass}, {'nonempty', 'scalar'}, 'DriveRawMotorsActionResult', 'Status');
        ...
        function result = get.Result(obj)
            ...
            if isempty(obj.Cache.Result)
                obj.Cache.Result = feval(obj.DriveControlDriveRawMotorsResultClass, obj.JavaMessage.getResult);
            end
        ...
        function set.Result(obj, result)
            ...
            validateattributes(result, {obj.DriveControlDriveRawMotorsResultClass}, {'nonempty', 'scalar'}, 'DriveRawMotorsActionResult', 'Result');
    ...
    methods (Access = protected)
        ...
        function reload(obj, strObj)
            ...
            obj.Result = feval([obj.DriveControlDriveRawMotorsResultClass '.loadobj'], strObj.Result);
        end
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.drive_control.DriveRawMotorsActionResult.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.drive_control.DriveRawMotorsActionResult;
            obj.reload(strObj);
        end
    end
end
