classdef DriveRawMotorsActionResult < ros.Message
    %DriveRawMotorsActionResult MATLAB implementation of sphero_msgs/DriveRawMotorsActionResult
    ...
    properties (Constant)
        MessageType = 'sphero_msgs/DriveRawMotorsActionResult' % The ROS message type
    end
    ...
    properties (Constant, Access = protected)
        ...
        SpheroMsgsDriveRawMotorsResultClass = ros.msg.internal.MessageFactory.getClassForType('sphero_msgs/DriveRawMotorsResult') % Dispatch to MATLAB class for message type sphero_msgs/DriveRawMotorsResult
    ...
    methods
        ...
        function result = get.Result(obj)
            ...
            if isempty(obj.Cache.Result)
                obj.Cache.Result = feval(obj.SpheroMsgsDriveRawMotorsResultClass, obj.JavaMessage.getResult);
            end
        ...
        function set.Result(obj, result)
            ...
            validateattributes(result, {obj.SpheroMsgsDriveRawMotorsResultClass}, {'nonempty', 'scalar'}, 'DriveRawMotorsActionResult', 'Result');
    ...
    methods (Access = protected)
        ...
        function reload(obj, strObj)
            ...
            obj.Result = feval([obj.SpheroMsgsDriveRawMotorsResultClass '.loadobj'], strObj.Result);
        end
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.sphero_msgs.DriveRawMotorsActionResult.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.sphero_msgs.DriveRawMotorsActionResult;
            obj.reload(strObj);
        end
    end
end
