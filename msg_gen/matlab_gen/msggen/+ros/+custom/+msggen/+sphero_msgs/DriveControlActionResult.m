classdef DriveControlActionResult < ros.Message
    ...
    properties (Constant, Access = protected)
        ...
        SpheroMsgsDriveControlResultClass = ros.msg.internal.MessageFactory.getClassForType('sphero_msgs/DriveControlResult') % Dispatch to MATLAB class for message type sphero_msgs/DriveControlResult
    ...
    methods
        function obj = DriveControlActionResult(msg)
            %DriveControlActionResult Construct the message object DriveControlActionResult
        ...
        function set.Header(obj, header)
            ...
            validateattributes(header, {obj.StdMsgsHeaderClass}, {'nonempty', 'scalar'}, 'DriveControlActionResult', 'Header');
        ...
        function set.Status(obj, status)
            ...
            validateattributes(status, {obj.ActionlibMsgsGoalStatusClass}, {'nonempty', 'scalar'}, 'DriveControlActionResult', 'Status');
        ...
        function result = get.Result(obj)
            ...
            if isempty(obj.Cache.Result)
                obj.Cache.Result = feval(obj.SpheroMsgsDriveControlResultClass, obj.JavaMessage.getResult);
            end
        ...
        function set.Result(obj, result)
            ...
            validateattributes(result, {obj.SpheroMsgsDriveControlResultClass}, {'nonempty', 'scalar'}, 'DriveControlActionResult', 'Result');
    ...
    methods (Access = protected)
        ...
        function reload(obj, strObj)
            ...
            obj.Result = feval([obj.SpheroMsgsDriveControlResultClass '.loadobj'], strObj.Result);
        end
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.sphero_msgs.DriveControlActionResult.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.sphero_msgs.DriveControlActionResult;
            obj.reload(strObj);
        end
    end
end
