classdef DriveControlActionGoal < ros.Message
    ...
    properties (Constant, Access = protected)
        ...
        SpheroMsgsDriveControlGoalClass = ros.msg.internal.MessageFactory.getClassForType('sphero_msgs/DriveControlGoal') % Dispatch to MATLAB class for message type sphero_msgs/DriveControlGoal
    ...
    methods
        function obj = DriveControlActionGoal(msg)
            %DriveControlActionGoal Construct the message object DriveControlActionGoal
        ...
        function set.Header(obj, header)
            ...
            validateattributes(header, {obj.StdMsgsHeaderClass}, {'nonempty', 'scalar'}, 'DriveControlActionGoal', 'Header');
        ...
        function set.GoalId(obj, goalid)
            ...
            validateattributes(goalid, {obj.ActionlibMsgsGoalIDClass}, {'nonempty', 'scalar'}, 'DriveControlActionGoal', 'GoalId');
        ...
        function goal = get.Goal(obj)
            ...
            if isempty(obj.Cache.Goal)
                obj.Cache.Goal = feval(obj.SpheroMsgsDriveControlGoalClass, obj.JavaMessage.getGoal);
            end
            goal = obj.Cache.Goal;
        end
        ...
        function set.Goal(obj, goal)
            ...
            validateattributes(goal, {obj.SpheroMsgsDriveControlGoalClass}, {'nonempty', 'scalar'}, 'DriveControlActionGoal', 'Goal');
    ...
    methods (Access = protected)
        ...
        function reload(obj, strObj)
            ...
            obj.Goal = feval([obj.SpheroMsgsDriveControlGoalClass '.loadobj'], strObj.Goal);
        end
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.sphero_msgs.DriveControlActionGoal.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.sphero_msgs.DriveControlActionGoal;
            obj.reload(strObj);
        end
    end
end
