classdef DriveRawMotorsActionGoal < ros.Message
    %DriveRawMotorsActionGoal MATLAB implementation of sphero_msgs/DriveRawMotorsActionGoal
    ...
    properties (Constant)
        MessageType = 'sphero_msgs/DriveRawMotorsActionGoal' % The ROS message type
    end
    
    properties (Constant, Hidden)
        MD5Checksum = '7f276e8cdb72b4654e0810bc3e86393f' % The MD5 Checksum of the message definition
    end
    ...
    properties (Constant, Access = protected)
        ...
        SpheroMsgsDriveRawMotorsGoalClass = ros.msg.internal.MessageFactory.getClassForType('sphero_msgs/DriveRawMotorsGoal') % Dispatch to MATLAB class for message type sphero_msgs/DriveRawMotorsGoal
    ...
    methods
        ...
        function goal = get.Goal(obj)
            ...
            if isempty(obj.Cache.Goal)
                obj.Cache.Goal = feval(obj.SpheroMsgsDriveRawMotorsGoalClass, obj.JavaMessage.getGoal);
            end
            goal = obj.Cache.Goal;
        end
        ...
        function set.Goal(obj, goal)
            ...
            validateattributes(goal, {obj.SpheroMsgsDriveRawMotorsGoalClass}, {'nonempty', 'scalar'}, 'DriveRawMotorsActionGoal', 'Goal');
    ...
    methods (Access = protected)
        ...
        function reload(obj, strObj)
            ...
            obj.Goal = feval([obj.SpheroMsgsDriveRawMotorsGoalClass '.loadobj'], strObj.Goal);
        end
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.sphero_msgs.DriveRawMotorsActionGoal.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.sphero_msgs.DriveRawMotorsActionGoal;
            obj.reload(strObj);
        end
    end
end
