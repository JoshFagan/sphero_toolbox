classdef DriveControlResult < ros.Message
    ...
    methods
        function obj = DriveControlResult(msg)
            %DriveControlResult Construct the message object DriveControlResult
        ...
        function set.Result(obj, result)
            ...
            validateattributes(result, {'numeric'}, {'nonempty', 'scalar'}, 'DriveControlResult', 'Result');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.sphero_msgs.DriveControlResult.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.sphero_msgs.DriveControlResult;
            obj.reload(strObj);
        end
    end
end
