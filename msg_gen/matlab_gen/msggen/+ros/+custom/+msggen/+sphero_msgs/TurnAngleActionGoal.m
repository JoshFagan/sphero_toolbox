classdef TurnAngleActionGoal < ros.Message
    %TurnAngleActionGoal MATLAB implementation of sphero_msgs/TurnAngleActionGoal
    ...
    properties (Constant)
        MessageType = 'sphero_msgs/TurnAngleActionGoal' % The ROS message type
    end
    
    properties (Constant, Hidden)
        MD5Checksum = '38790f31b68003534a7f9f94be97c3c7' % The MD5 Checksum of the message definition
    end
    ...
    properties (Constant, Access = protected)
        ...
        SpheroMsgsTurnAngleGoalClass = ros.msg.internal.MessageFactory.getClassForType('sphero_msgs/TurnAngleGoal') % Dispatch to MATLAB class for message type sphero_msgs/TurnAngleGoal
    ...
    methods
        function obj = TurnAngleActionGoal(msg)
            %TurnAngleActionGoal Construct the message object TurnAngleActionGoal
        ...
        function set.Header(obj, header)
            ...
            validateattributes(header, {obj.StdMsgsHeaderClass}, {'nonempty', 'scalar'}, 'TurnAngleActionGoal', 'Header');
        ...
        function set.GoalId(obj, goalid)
            ...
            validateattributes(goalid, {obj.ActionlibMsgsGoalIDClass}, {'nonempty', 'scalar'}, 'TurnAngleActionGoal', 'GoalId');
        ...
        function goal = get.Goal(obj)
            ...
            if isempty(obj.Cache.Goal)
                obj.Cache.Goal = feval(obj.SpheroMsgsTurnAngleGoalClass, obj.JavaMessage.getGoal);
            end
            goal = obj.Cache.Goal;
        end
        ...
        function set.Goal(obj, goal)
            ...
            validateattributes(goal, {obj.SpheroMsgsTurnAngleGoalClass}, {'nonempty', 'scalar'}, 'TurnAngleActionGoal', 'Goal');
    ...
    methods (Access = protected)
        ...
        function reload(obj, strObj)
            ...
            obj.Goal = feval([obj.SpheroMsgsTurnAngleGoalClass '.loadobj'], strObj.Goal);
        end
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.sphero_msgs.TurnAngleActionGoal.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.sphero_msgs.TurnAngleActionGoal;
            obj.reload(strObj);
        end
    end
end
