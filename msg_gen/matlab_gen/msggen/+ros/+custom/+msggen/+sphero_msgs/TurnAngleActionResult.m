classdef TurnAngleActionResult < ros.Message
    %TurnAngleActionResult MATLAB implementation of sphero_msgs/TurnAngleActionResult
    ...
    properties (Constant)
        MessageType = 'sphero_msgs/TurnAngleActionResult' % The ROS message type
    end
    ...
    properties (Constant, Access = protected)
        ...
        SpheroMsgsTurnAngleResultClass = ros.msg.internal.MessageFactory.getClassForType('sphero_msgs/TurnAngleResult') % Dispatch to MATLAB class for message type sphero_msgs/TurnAngleResult
    ...
    methods
        function obj = TurnAngleActionResult(msg)
            %TurnAngleActionResult Construct the message object TurnAngleActionResult
        ...
        function set.Header(obj, header)
            ...
            validateattributes(header, {obj.StdMsgsHeaderClass}, {'nonempty', 'scalar'}, 'TurnAngleActionResult', 'Header');
        ...
        function set.Status(obj, status)
            ...
            validateattributes(status, {obj.ActionlibMsgsGoalStatusClass}, {'nonempty', 'scalar'}, 'TurnAngleActionResult', 'Status');
        ...
        function result = get.Result(obj)
            ...
            if isempty(obj.Cache.Result)
                obj.Cache.Result = feval(obj.SpheroMsgsTurnAngleResultClass, obj.JavaMessage.getResult);
            end
        ...
        function set.Result(obj, result)
            ...
            validateattributes(result, {obj.SpheroMsgsTurnAngleResultClass}, {'nonempty', 'scalar'}, 'TurnAngleActionResult', 'Result');
    ...
    methods (Access = protected)
        ...
        function reload(obj, strObj)
            ...
            obj.Result = feval([obj.SpheroMsgsTurnAngleResultClass '.loadobj'], strObj.Result);
        end
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.sphero_msgs.TurnAngleActionResult.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.sphero_msgs.TurnAngleActionResult;
            obj.reload(strObj);
        end
    end
end
