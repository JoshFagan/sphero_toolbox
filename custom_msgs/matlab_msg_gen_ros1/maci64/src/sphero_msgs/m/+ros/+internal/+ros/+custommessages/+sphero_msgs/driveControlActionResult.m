function [data, info] = driveControlActionResult
%DriveControlActionResult gives an empty data for sphero_msgs/DriveControlActionResult
% Copyright 2019-2020 The MathWorks, Inc.
%#codegen
data = struct();
data.MessageType = 'sphero_msgs/DriveControlActionResult';
...
[data.Result, info.Result] = ros.internal.ros.custommessages.sphero_msgs.driveControlResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'sphero_msgs/DriveControlActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
