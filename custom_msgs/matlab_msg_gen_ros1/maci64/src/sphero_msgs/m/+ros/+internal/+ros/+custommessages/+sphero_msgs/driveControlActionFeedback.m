function [data, info] = driveControlActionFeedback
%DriveControlActionFeedback gives an empty data for sphero_msgs/DriveControlActionFeedback
% Copyright 2019-2020 The MathWorks, Inc.
%#codegen
data = struct();
data.MessageType = 'sphero_msgs/DriveControlActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.custommessages.sphero_msgs.driveControlFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'sphero_msgs/DriveControlActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
